...
// Wygenerowana automatycznie czcionka 'tiny_8x8' (8x8)
// Każdy znak: 8 kolumn * 1 bajt(ów) na kolumnę = 8 bajtów.
// Format bitów: LSB = piksel górny, kolejne bity w dół.

#define TINY_8X8_WIDTH 8
#define TINY_8X8_HEIGHT 8
#define TINY_8X8_BYTES_PER_COL 1

static const uint8_t OLED_Font_tiny_8x8[95][8] =
{
...
const SSD1306_Font_t SSD1306_Font_tiny_8x8 =
{
  .width      = 8,
  .height     = 8,
  .first_char = 0x20,
  .last_char  = 0x7E,
  .data       = &OLED_Font_tiny_8x8[0][0]
};

...
// Wygenerowana automatycznie czcionka 'small_6x8' (6x8)
// Każdy znak: 6 kolumn * 1 bajt(ów) na kolumnę = 6 bajtów.
// Format bitów: LSB = piksel górny, kolejne bity w dół.

#define SMALL_6X8_WIDTH 6
#define SMALL_6X8_HEIGHT 8
#define SMALL_6X8_BYTES_PER_COL 1

static const uint8_t OLED_Font_small_6x8[95][6] =
{
    ...
    {0xAA,0x55,0xAA,0x55,0xAA,0x55}, // 0x5C '\\'
    ...
    {0x00,0x00,0x10,0x7C,0x82,0x00}, // 0x7B '{'
    {0x00,0x00,0x00,0xFF,0x00,0x00}, // 0x7C '|'
    {0x00,0x00,0x82,0x7C,0x10,0x00}, // 0x7D '}'
    {0x00,0x00,0x06,0x09,0x09,0x06}, // 0x7E '~'
};

const SSD1306_Font_t SSD1306_Font_small_6x8 =
{
  .width      = 6,
  .height     = 8,
  .first_char = 0x20,
  .last_char  = 0x7E,
  .data       = &OLED_Font_small_6x8[0][0]
};
